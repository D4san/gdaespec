...
def main():
    ...
    star = create_star(
        ...
        f_spot=0.01, T_spot=0.86 * T_s,
        f_fac=0.08,  T_fac=T_s + 100.0,
    )
    ...
    observation = "f1s1_1transits.dat"
    ...
    # ================================ Modelo ==================================
    model_name = "contam_1T_1spot-1fac"
    ...
    T_fine = np.arange(250.0, 450.0 + 10.0, 10.0)         # K
    log_P_fine = np.arange(-3.0, 20.0 + 0.2, 0.2)          # log10(P/bar)
